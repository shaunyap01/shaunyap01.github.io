...
date: 2024-05-03
lastmod: 2024-05-03
tags: ["`Python", "$$All Projects", "^Kaggle Competition", "Exploratory Data Analysis", "Flood Prediction", "Data Visualisation", "Large Dataset"]
author: "Shaun Yap"
description: "" 
...
```
    ...
    c:\Users\shaun\anaconda3\Lib\site-packages\umap\umap_.py:1952: UserWarning: n_jobs value 1 overridden to 1 by setting random_state. Use no seed for parallelism.
      warn(
...
```
    ...
    c:\Users\shaun\anaconda3\Lib\site-packages\sklearn\manifold\_t_sne.py:1162: FutureWarning: 'n_iter' was renamed to 'max_iter' in version 1.5 and will be removed in 1.7.
      warnings.warn(
